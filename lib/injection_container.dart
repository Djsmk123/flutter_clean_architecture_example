...
import 'features/number_trivia/data/respositories/number_trivia_repo_impl.dart';
...
Future<void> init() async {
  ...
  // Repository
   ...
   // Data sources
    sl.registerLazySingleton(() => NumberTriviaRemoteDataSourceImpl(
      client: sl(),
    ));
    sl.registerLazySingleton(() => NumberTriviaLocalDataSourceImpl(
      sl(),
    ));
